...
class TestJobDescriptionParsedRepo(BaseTestCase):
    ...
    def test_create(self):
        ...
        parsed_id = self.job_desc_parsed_repo.create_parsed_from_fields(
    ...
    def test_get_by_job_id(self):
        ...
        _ = self.job_desc_parsed_repo.create_parsed_from_fields(
            job_id, "Summary", "skill1,skill2", "skill3", "keyword1,keyword2"
        )
    ...
    def test_get_all(self):
        ...
        self.job_desc_parsed_repo.create_parsed_from_fields(
