...
class TestUserRepo(BaseTestCase):
    ...
    def test_get_all(self):
        self.user_repo.create_from_fields("User1", "user1@example.com")
        self.user_repo.create_from_fields("User2", "user2@example.com")
        users = self.user_repo.get_all()
    ...
    def test_update(self):
        user_id = self.user_repo.create_from_fields("Old Name", "old@example.com")
    ...
    def test_update_partial(self):
        user_id = self.user_repo.create_from_fields("Test", "test@example.com")
    ...
    def test_delete(self):
        user_id = self.user_repo.create_from_fields("To Delete", "delete@example.com")
