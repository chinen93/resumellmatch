...
class TestMatchRepo(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.resume_id = self.resume_repo.create_from_fields(
            self.user_id, "Resume text"
        )
        self.job_id = self.job_desc_repo.create_from_fields(
            "http://example.com", "Engineer", "Job text"
        )
        self.parsed_id = self.job_desc_parsed_repo.create_parsed_from_fields(
    ...
    def test_get_all(self):
        ...
        parsed_id2 = self.job_desc_parsed_repo.create_parsed_from_fields(
